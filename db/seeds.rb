...
#Prescription
@prescrip1 = Prescription.new(patient_id: @patient1.id, rxcui: 541894, start_datetime: Time.now + 15.minutes, end_datetime: Time.now + 5.days, doctor_id: @doctor1.id, side_effects: nil, image_url: "http://pillbox.nlm.nih.gov/assets/small/540920173.jpg", medication_name: "Dextroamphetamine saccharate 2.5 MG")
